...
import erc721 from "./erc721AddressList_04.json";
import erc1155 from "./erc1155AddressList_04.json";
...
async function getContract(address: string, blockNumber: number, txh: string) {
  try {
    ...
    if (_) {
      ...
      writeFileNft(erc721AddressList, "erc721AddressList_04");
      return;
    }
    ...
    if (__) {
      ...
      writeFileNft(erc1155AddressList, "erc1155AddressList_04");
      return;
    }
  } catch (e) {
    // console.log(e);
